...
/** @addtogroup MDR32VF0xI_Memory_Map Memory Map
 * @{
 */

#if defined(USE_MDR32F02)
/**
 * @brief MDR32F02 base addresses and sizes.
 */

#define BOOT_OTP_BASE      (0x00020000UL)
#define BOOT_OTP_SIZE      (0x00004000UL)
...
#define CRYPTO_REGION_BASE (0x60000000UL)

#define OTP_BASE           (0x70000000UL)
#define OTP_MEM_BASE       OTP_BASE
#define OTP_MEM_SIZE       BOOT_OTP_SIZE

#define RAM_TCMA_BASE      (0x80000000UL)
#define RAM_TCMA_SIZE      (0x00010000UL)

#define RAM_TCMB_BASE      (0x80010000UL)
...
#define BOOT_FLASH_BASE (0x00020000UL)
#define BOOT_FLASH_SIZE (0x00003C00UL)
...
#define RAM_TCMA_BASE   (0x50000000UL)
#define RAM_TCMA_SIZE   (0x00010000UL)

#define RAM_TCMB_BASE   (0x50010000UL)
#define RAM_TCMB_SIZE   (0x00008000UL)
...
#if defined(USE_MDR32F02)
/**
 * @brief MDR32F02 OTP memory.
 */
#define OTP_MEM ((uint32_t*)OTP_MEM_BASE)

/**
 * @brief MDR32F02 OTP special fields.
 */
typedef struct
{
    __I uint32_t  UNIQ_ID[5];
    __I uint32_t  BG_TRIM;
    __I uint32_t  HSI_TRIM;
...
#elif defined(USE_MDR32F02_REV_2) || defined(USE_MDR1206)
...
#if defined(USE_MDR32F02_REV_2) || defined(USE_MDR1206)
...
typedef struct {
    ...
    __IO uint32_t DI;  /*!<FLASH Read Data Register */
    __I uint32_t  DO;  /*!<FLASH Write Data Register */
    __IO uint32_t KEY; /*!<FLASH Key Register */
#if defined(USE_MDR1206)
    __IO uint32_t CTRL;         /*!<FLASH Test Functions Register */
    __IO uint32_t CHIP_ID_CTRL; /*!<FLASH Chip ID Register */
#endif
} MDR_FLASH_TypeDef;
...
#define FLASH_CMD_DELAY_Msk     (0x3UL << FLASH_CMD_DELAY_Pos)
...
#define FLASH_ADR_ADR_Pos 0
#define FLASH_ADR_ADR_Msk (0xFFFFFFFFUL << FLASH_ADR_ADR_Pos)
...
#define FLASH_CTRL_BYTE0      (0x1UL << FLASH_CTRL_BYTE_Pos)
#define FLASH_CTRL_BYTE1      (0x2UL << FLASH_CTRL_BYTE_Pos)
#define FLASH_CTRL_BYTE2      (0x4UL << FLASH_CTRL_BYTE_Pos)
#define FLASH_CTRL_BYTE3      (0x8UL << FLASH_CTRL_BYTE_Pos)
...
#define FLASH_CHIP_ID_CTRL_OTPTST1_Pos 0
#define FLASH_CHIP_ID_CTRL_OTPTST1_Msk (0x1UL << FLASH_CHIP_ID_CTRL_OTPTST1_Pos)
#define FLASH_CHIP_ID_CTRL_OTPTST1     FLASH_CHIP_ID_CTRL_OTPTST1_Msk
...
#define WWDG_CFR_WDGTB_Msk ((uint32_t)0x3UL << WWDG_CFR_WDGTB_Pos)
...
typedef struct {
    ...
    __I uint32_t  RTC_TSTR1;       /*!<RTC Tamper1 Timestamp */
    __I uint32_t  RTC_TSTR2;       /*!<RTC Tamper2 Timestamp */
    __I uint32_t  RTC_TSTR3;       /*!<RTC Tamper3 Timestamp */
    __I uint32_t  RTC_TSDR1;       /*!<RTC Tamper1 Datestamp */
    __I uint32_t  RTC_TSDR2;       /*!<RTC Tamper2 Datestamp */
    __I uint32_t  RTC_TSDR3;       /*!<RTC Tamper3 Datestamp */
    __IO uint32_t RTC_TAFCR;       /*!<RTC Tamper Control Register */
...
#define BKP_LDO_COVDET_Pos     26
#define BKP_LDO_COVDET_Msk     (0x1UL << BKP_LDO_COVDET_Pos)
...
#define BKP_CLK_HSI_TRIM_Pos 15
#define BKP_CLK_HSI_TRIM_Msk (0x3FUL << BKP_CLK_HSI_TRIM_Pos)
...
#define BKP_RTC_CR_RTC_EN_Pos              1
...
#define BKP_RTC_CS_ALRAE_Pos   7
#define BKP_RTC_CS_ALRAE_Msk   (0x1UL << BKP_RTC_CS_ALRAE_Pos)
#define BKP_RTC_CS_ALRAE       BKP_RTC_CS_ALRAE_Msk

#define BKP_RTC_CS_ALRBE_Pos   8
#define BKP_RTC_CS_ALRBE_Msk   (0x1UL << BKP_RTC_CS_ALRBE_Pos)
#define BKP_RTC_CS_ALRBE       BKP_RTC_CS_ALRBE_Msk
...
#define BKP_RTC_CS_ALRA_IE_Pos 11
#define BKP_RTC_CS_ALRA_IE_Msk (0x1UL << BKP_RTC_CS_ALRA_IE_Pos)
#define BKP_RTC_CS_ALRA_IE     BKP_RTC_CS_ALRA_IE_Msk

#define BKP_RTC_CS_ALRB_IE_Pos 12
#define BKP_RTC_CS_ALRB_IE_Msk (0x1UL << BKP_RTC_CS_ALRB_IE_Pos)
#define BKP_RTC_CS_ALRB_IE     BKP_RTC_CS_ALRB_IE_Msk
...
#define BKP_RTC_TAFCR_TAMPE_Pos       0
#define BKP_RTC_TAFCR_TAMPE_Msk       (0x1UL << BKP_RTC_TAFCR_TAMPE_Pos)
...
#define BKP_RTC_TAFCR_TSE_Pos         5
#define BKP_RTC_TAFCR_TSE_Msk         (0x1UL << BKP_RTC_TAFCR_TSE_Pos)
#define BKP_RTC_TAFCR_TSE             BKP_RTC_TAFCR_TSE_Msk

#define BKP_RTC_TAFCR_TSE_EDGE_Pos    6
#define BKP_RTC_TAFCR_TSE_EDGE_Msk    (0x7UL << BKP_RTC_TAFCR_TSE_EDGE_Pos)
#define BKP_RTC_TAFCR_TSE_EDGE1       (0x1UL << BKP_RTC_TAFCR_TSE_EDGE_Pos)
#define BKP_RTC_TAFCR_TSE_EDGE2       (0x2UL << BKP_RTC_TAFCR_TSE_EDGE_Pos)
#define BKP_RTC_TAFCR_TSE_EDGE3       (0x4UL << BKP_RTC_TAFCR_TSE_EDGE_Pos)
...
#define BKP_RTC_TAFCR_TAMPE_W_Pos      23
#define BKP_RTC_TAFCR_TAMPE_W_Msk      (0x7UL << BKP_RTC_TAFCR_TAMPE_W_Pos)
#define BKP_RTC_TAFCR_TAMPE_W1         (0x1UL << BKP_RTC_TAFCR_TAMPE_W_Pos)
#define BKP_RTC_TAFCR_TAMPE_W2         (0x2UL << BKP_RTC_TAFCR_TAMPE_W_Pos)
#define BKP_RTC_TAFCR_TAMPE_W3         (0x4UL << BKP_RTC_TAFCR_TAMPE_W_Pos)

#define BKP_RTC_TAFCR_EVNT_FRONT_W_Pos 26
#define BKP_RTC_TAFCR_EVNT_FRONT_W_Msk (0x7UL << BKP_RTC_TAFCR_EVNT_FRONT_W_Pos)
#define BKP_RTC_TAFCR_EVNT_FRONT_W1    (0x1UL << BKP_RTC_TAFCR_EVNT_FRONT_W_Pos)
#define BKP_RTC_TAFCR_EVNT_FRONT_W2    (0x2UL << BKP_RTC_TAFCR_EVNT_FRONT_W_Pos)
#define BKP_RTC_TAFCR_EVNT_FRONT_W3    (0x4UL << BKP_RTC_TAFCR_EVNT_FRONT_W_Pos)

#define BKP_RTC_TAFCR_EVNT_LEVEL_W_Pos 29
#define BKP_RTC_TAFCR_EVNT_LEVEL_W_Msk (0x7UL << BKP_RTC_TAFCR_EVNT_LEVEL_W_Pos)
#define BKP_RTC_TAFCR_EVNT_LEVEL_W1    (0x1UL << BKP_RTC_TAFCR_EVNT_LEVEL_W_Pos)
#define BKP_RTC_TAFCR_EVNT_LEVEL_W2    (0x2UL << BKP_RTC_TAFCR_EVNT_LEVEL_W_Pos)
#define BKP_RTC_TAFCR_EVNT_LEVEL_W3    (0x4UL << BKP_RTC_TAFCR_EVNT_LEVEL_W_Pos)
...
#define BKP_RTC_TMPCAL1_CONST6_LOW_Msk (0x2UL << BKP_RTC_TMPCAL1_CONST6_LOW_Pos)
...
#define BKP_RTC_TMPCAL2_CONST12_LOW_Msk (0x2UL << BKP_RTC_TMPCAL2_CONST12_LOW_Pos)
...
#define BKP_RTC_TMPCAL3_LSECONF_B3_Pos   3
#define BKP_RTC_TMPCAL3_LSECONF_B3_Msk   (0x1UL << BKP_RTC_TMPCAL3_LSECONF_B3_Pos)
#define BKP_RTC_TMPCAL3_LSECONF_B3       BKP_RTC_TMPCAL3_LSECONF_B3_Msk

#define BKP_RTC_TMPCAL3_EN_TEMP_Pos      4
#define BKP_RTC_TMPCAL3_EN_TEMP_Msk      (0x1UL << BKP_RTC_TMPCAL3_EN_TEMP_Pos)
#define BKP_RTC_TMPCAL3_EN_TEMP          BKP_RTC_TMPCAL3_EN_TEMP_Msk
...
#define BKP_RTC_TMPCAL3_RESULT_TEMP_Pos  24
#define BKP_RTC_TMPCAL3_RESULT_TEMP_Msk  (0xFUL << BKP_RTC_TMPCAL3_RESULT_TEMP_Pos)

#define BKP_RTC_TMPCAL3_RESULT_READY_Pos 28
#define BKP_RTC_TMPCAL3_RESULT_READY_Msk (0x1UL << BKP_RTC_TMPCAL3_RESULT_READY_Pos)
...
/** @defgroup MDR32F02_ADCUI_F0CTR ADCUI F0CTR for Сhannel 0
 * @{
 */
...
/** @defgroup MDR32VF0xI_ADCUI_FxCTR ADCUI FxCTR for Сhannels 1 and 2
 * @{
 */
...
#define ADCUI_FxCTR_FxIGAIN_0dB  (0x0UL << ADCUI_FxCTR_FxIGAIN_Pos)
#define ADCUI_FxCTR_FxIGAIN_6dB  (0x1UL << ADCUI_FxCTR_FxIGAIN_Pos)
#define ADCUI_FxCTR_FxIGAIN_12dB (0x2UL << ADCUI_FxCTR_FxIGAIN_Pos)
#define ADCUI_FxCTR_FxIGAIN_18dB (0x3UL << ADCUI_FxCTR_FxIGAIN_Pos)
...
/** @defgroup MDR32VF0xI_ADCUI_F0AC ADCUI F0AC for Сhannel 0
 * @{
 */
...
/** @defgroup MDR32VF0xI_ADCUI_FxAC ADCUI FxAC for Сhannels 1 and 2
 * @{
 */
...
/** @defgroup MDR32VF0xI_ADCUI_F0MD0 ADCUI F0MD0 for Сhannel 0
 * @{
 */
...
/** @defgroup MDR32VF0xI_ADCUI_FxMD0 ADCUI FxMD0 for Сhannels 1 and 2
 * @{
 */
...
/** @defgroup MDR32VF0xI_ADCUI_FxI0DAT ADCUI FxI0DAT
 * @{
 */
...
/** @} */ /* End of group MDR32VF0xI_ADCUI_FxI0DAT */

/** @defgroup MDR32VF0xI_ADCUI_FxI3DAT ADCUI FxI3DAT
 * @{
 */
...
/** @} */ /* End of group MDR32VF0xI_ADCUI_FxI3DAT */
...
/** @defgroup MDR32VF0xI_ADCUI_F0STAT ADCUI F0STAT for Сhannel 0
 * @{
 */
...
/** @defgroup MDR32VF0xI_ADCUI_FxSTAT ADCUI FxSTAT for Сhannels 1 and 2
 * @{
 */
...
/** @defgroup MDR32VF0xI_ADCUI_F0MASK ADCUI F0MASK for Сhannel 0
 * @{
 */
...
/** @defgroup MDR32VF0xI_ADCUI_FxMASK ADCUI FxMASK for Сhannels 1 and 2
 * @{
 */
...
#define ADCUI_FILTERCFG_CLRMS_COEFF_Pos 0
#define ADCUI_FILTERCFG_CLRMS_COEFF_Msk (0xFFFUL << ADCUI_FILTERCFG_CLRMS_COEFF_Pos)

#define ADCUI_FILTERCFG_CHP_ADC_CFG_Pos 0
...
#define PORT_PWR_PWR0    (0x1UL << 0)
#define PORT_PWR_PWR1    (0x1UL << 2)
#define PORT_PWR_PWR2    (0x1UL << 4)
#define PORT_PWR_PWR3    (0x1UL << 6)
#define PORT_PWR_PWR4    (0x1UL << 8)
#define PORT_PWR_PWR5    (0x1UL << 10)
#define PORT_PWR_PWR6    (0x1UL << 12)
#define PORT_PWR_PWR7    (0x1UL << 14)
#define PORT_PWR_PWR8    (0x1UL << 16)
#define PORT_PWR_PWR9    (0x1UL << 18)
#define PORT_PWR_PWR10   (0x1UL << 20)
#define PORT_PWR_PWR11   (0x1UL << 22)
#define PORT_PWR_PWR12   (0x1UL << 24)
#define PORT_PWR_PWR13   (0x1UL << 26)
#define PORT_PWR_PWR14   (0x1UL << 28)
#define PORT_PWR_PWR15   (0x1UL << 30)
...
#define RANDOM_STAT_CTRL_MASK_Msk                (0x3FUL << RANDOM_STAT_CTRL_MASK_Pos)
...
#define RANDOM_STAT_CTRL_WORK_MODE_Msk           (0x3FUL << RANDOM_STAT_CTRL_WORK_MODE_Pos)
#define RANDOM_STAT_CTRL_WORK_MODE_STOP          (0x0FUL << RANDOM_STAT_CTRL_WORK_MODE_Pos)
#define RANDOM_STAT_CTRL_WORK_MODE_SINGLE        (0x1FUL << RANDOM_STAT_CTRL_WORK_MODE_Pos)
#define RANDOM_STAT_CTRL_WORK_MODE_START_ON_READ (0x2FUL << RANDOM_STAT_CTRL_WORK_MODE_Pos)
#define RANDOM_STAT_CTRL_WORK_MODE_CONTINUOUS    (0x3FUL << RANDOM_STAT_CTRL_WORK_MODE_Pos)

#define RANDOM_STAT_CTRL_BIT_CNT_Pos             12
#define RANDOM_STAT_CTRL_BIT_CNT_Msk             (0x1FUL << RANDOM_STAT_CTRL_BIT_CNT_Pos)
...
#define RANDOM_INT_CTRL_UNREAD_DATA_Pos 0
...
typedef struct {
    ...
    __I uint32_t  STAT;          /*!<OTP Blocks Status Register */
    ...
    __IO uint32_t DIR_CTRL;      /*!<OTP Direct Control Register */
    __IO uint32_t DIR_DATA;      /*!<OTP Direct Control Data Register */
...
#define OTP_STAT_CTRL_DIR_ACK_Pos             11
#define OTP_STAT_CTRL_DIR_ACK_Msk             (0x1UL << OTP_STAT_CTRL_DIR_ACK_Pos)
#define OTP_STAT_CTRL_DIR_ACK                 OTP_STAT_CTRL_DIR_ACK_Msk

#define OTP_STAT_CTRL_DIR_ERR_Pos             12
#define OTP_STAT_CTRL_DIR_ERR_Msk             (0x1UL << OTP_STAT_CTRL_DIR_ERR_Pos)
...
#define OTP_STAT_OTP_0_FSM_STATE_Pos 0
#define OTP_STAT_OTP_0_FSM_STATE_Msk (0x1FUL << OTP_STAT_OTP_0_FSM_STATE_Pos)

#define OTP_STAT_OTP_0_LOCK_Pos      6
#define OTP_STAT_OTP_0_LOCK_Msk      (0x1UL << OTP_STAT_OTP_0_LOCK_Pos)
#define OTP_STAT_OTP_0_LOCK          OTP_STAT_OTP_0_LOCK_Msk

#define OTP_STAT_OTP_0_BUSY_Pos      7
#define OTP_STAT_OTP_0_BUSY_Msk      (0x1UL << OTP_STAT_OTP_0_BUSY_Pos)
#define OTP_STAT_OTP_0_BUSY          OTP_STAT_OTP_0_BUSY_Msk
...
#define OTP_RW_CMD_DATA_0_Pos   24
#define OTP_RW_CMD_DATA_0_Msk   (0x1UL << OTP_RW_CMD_DATA_0_Pos)
#define OTP_RW_CMD_DATA_0       OTP_RW_CMD_DATA_0_Msk
...
#define OTP_READ_DATA_DATA_0_Pos 0
#define OTP_READ_DATA_DATA_0_Msk (0xFFUL << OTP_READ_DATA_DATA_0_Pos)
...
#define OTP_TEST_OPT_ATPG_Pos  8
#define OTP_TEST_OPT_ATPG_Msk  (0xFFFFFFUL << OTP_TEST_OPT_ATPG_Pos)
